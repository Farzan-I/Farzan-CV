...
| [Acebook](https://github.com/Farzan-I/facebook-clone) | Group | A Facebook clone for which I learnt MEHN stack in a week | MEHN stack (MongoDB, Express, Handlebars and Node.js), CSS3, HTML5, Cypress, Mongoose, Jest, Bcrypt, ESlint, Git |
...
* Solely built the website for my previous employer in four days with no prior coding knowledge ([Cultural Signatures](#cultural-signatures-mar-2020-to-nov-2020)). Done using [Codecademy](https://www.codecademy.com/) and [W3 Schools](https://www.w3schools.com/) to show me the basics. Looking back, I can vastly improve every aspect of the website comfortably having learnt more skills and tech tools at Makers
